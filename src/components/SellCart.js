...
class SellCart extends React.Component {
        ...
        return (
            <TouchableWithoutFeedback onPress={() => {
                ...
                <View style={style.cartBody}>
                    ...
                    <View style={{width: '100%', height: 25, flexDirection: 'row', paddingLeft: 3}}>
                        <Text
                            style={{fontFamily: 'IRANSansBold'}}>{SellCart.formatNumber(discounted_price)} تومان</Text>
                        {discount_percent !== 0 ?
                            <Text style={{
                                ...
                                color: 'gray',
                                marginLeft: 10,
                            }}>{SellCart.formatNumber(price)}</Text>
                            : null}
                    </View>
                    <View style={{
...
export default withNavigation(connect(mapStateToProps, mapDispatchToProps)(SellCart));
const style = {
    discountPercent: {
        fontFamily: 'IRANSansNumber',
